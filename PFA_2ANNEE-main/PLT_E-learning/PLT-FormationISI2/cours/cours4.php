<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F8-24'){
                $F8_24=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F8-25'){
                $F8_25=$AffichierCour['Position'];
            }
        }
    $F8='- Cours -';
    }else{
        ...
        <div class="contant">
            <table>
                    <tr><td>
                        ...
                        <a href="<?php echo $F8_24;?>" class="sapn"><?php echo $F8;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Séminaires</a>
                        <a href="<?php echo $F8_25;?>" class="sapn"><?php echo $F8;?></a>
                    </td</tr>
                </table>
        </div>
    </section>
