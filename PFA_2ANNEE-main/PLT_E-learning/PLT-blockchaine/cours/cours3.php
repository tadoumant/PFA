        ...
        <div class="contant">
            <table>
                    <?php 
                        ...
                        if($AffichierCour['ID_Mat'] == 'F11-3'):
                    ?>
                    <tr><td>
                        <a href="#">Maîtriser Geth (installer, exécuter un noeud)</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Créer et interagir avec sa propre Blockchain privée</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Installer et utiliser Metamask</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Découvrir et manipuler Remix</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Maîriser Ganache (installer, configurer avec Metamsk)</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Déployer sur Ganache</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
