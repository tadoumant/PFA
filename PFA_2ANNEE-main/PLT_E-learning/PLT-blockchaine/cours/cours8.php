        ...
        <div class="contant">
            <table>
                    <?php 
                        ...
                        if($AffichierCour['ID_Mat'] == 'F11-8'):
                    ?>
                    <tr><td>
                        <a href="#">Acquérir les notions CI/CD</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Implémenter des tests fonctionnels, assurer le fonctionnement du smart contract avant déploiement</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Déployer sa Dapp sur Heroku et github Pages</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
