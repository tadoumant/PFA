        ...
        <div class="contant">
            <table>
                <?php 
                    ...
                    if($AffichierCour['ID_Mat'] == 'F11-9'):
                ?>
                    <tr><td>
                        <a href="#">Découvrir la finance décentralisée</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Découvrir les protocoles de la DeFi</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Développer des smart contracts pour la DeFi</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Interagir avec les protocoles de la DeFi (aave, uniswap, etc.)</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
