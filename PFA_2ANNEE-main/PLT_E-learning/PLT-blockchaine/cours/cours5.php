        ...
        <div class="contant">
            <table>
                <?php 
                    ...
                    if($AffichierCour['ID_Mat'] == 'F11-5'):
                ?>
                    <tr><td>
                        <a href="#">Acquérir les bonnes pratiques solidity</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Optimiser son smart contract en matière de consommation de gas</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Connaître les principales vulnérabilités d’un smart contract</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Auditer un smart contract</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
