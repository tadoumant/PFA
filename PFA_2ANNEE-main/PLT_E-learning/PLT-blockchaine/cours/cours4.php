        ...
        <div class="contant">
            <table>
                    <?php 
                        ...
                        if($AffichierCour['ID_Mat'] == 'F11-4'):
                    ?>
                    <tr><td>
                        <a href="#">Maîtriser la syntaxe de solidity</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Concevoir un smart contract</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Développer et Déployer un smart contract</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
