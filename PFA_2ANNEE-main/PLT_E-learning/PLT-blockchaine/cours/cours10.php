        ...
        <div class="contant">
            <table>
                    <?php 
                        ...
                        if($AffichierCour['ID_Mat'] == 'F11-10'):
                    ?>
                    <tr><td>
                        <a href="#">Présenter ses compétences à l’oral et à l’écrit</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Respecter le bon formalisme pour le CV</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Négocier sa rémunération</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
