...
<body>
    ...
    <section class="home home5"> 
        <div class="contant">
            <table>
                    <?php foreach($AffichierCour as $AffichierCour):
                        if($AffichierCour['ID_Mat'] == 'F11-1'):
                    ?>
                    <tr><td>
                        <a href="#">Comprendre et interagir avec une architecture décentralisée</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Comprendre le fonctionnement de la preuve de travail</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Passer une transaction simple</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Décrire la structure d’un bloc</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Connaître les risques liés à l’usage des technologies de registre distribué</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
