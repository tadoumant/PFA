<?php
    ...
    $AffichierCour=$database->prepare("SELECT * FROM Cours WHERE ID_Formation='11' ");
        ...
        <div class="contant">
            <table>
                <?php 
                    ...
                    if($AffichierCour['ID_Mat'] == 'F11-6'):
                ?>
                    <tr><td>
                        <a href="#">Découvrir et utiliser web3</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Découvrir et utiliser infura</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Découvrir et développer un front-end avec ReactJs</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Concevoir, configurer et développer sa propre application décentralisée avec Truffle</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Déployer son smart contract sur Ethereum à l’aide du processus de migration de Truffle</a>
                        <a href="<?php echo $AffichierCour['Position'];?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
