<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F3-22'){
                $F3_22=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F3-23'){
                $F3_23=$AffichierCour['Position'];
            }
        }
    $F3='- Cours -';
    }else{
        ...
        <div class="contant">
            <table>
                    <tr><td>
                        ...
                        <a href="<?php echo $F3_22;?>" class="sapn"><?php echo $F3;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Séminaires</a>
                        <a href="<?php echo $F3_23;?>" class="sapn"><?php echo $F3;?></a>
                    </td</tr>
                </table>
        </div>
    </section>
