<?php
    ...
    // BASE DE DONNEES
        ...
        $info=$database->prepare("SELECT * FROM NoteEtu WHERE ID_Etu='{$unique_id}' AND  ID_Formation='3'");
        if($info->execute()){
        ...
        <div class="contant">
            <h3>Les cours que je suis : </h3>
                ...
                <table>
                    ...
                    <tr>
                        <td><a href="#">Marketing de Vente, d’Achat et de Négociation </a></td>
                    ...
                    <tr>
                        <td><a href="#">Publicité et Concurrence</a></td>
                ...
                <table>
                    ...
                    <tr>
                        <td><a href="#">Marketing Digital</a></td>
