<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F5-39'){
                $F5_39=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F5-40'){
                $F5_40=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F5-41'){
                $F5_41=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F5-42'){
                $F5_42=$AffichierCour['Position'];
            }
        }
    $F5=' - Cours - ';
    }else{
...
<body>
    ...
    <section class="home home5"> 
        <div class="contant">
            <table>
                    <tr><td>
                        <a href="#">Gestion de la Production et de la maintenance</a>
                        <a href="<?php echo $F5_39;?>" class="sapn"><?php echo $F5; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#"> Management de la Qualité</a>
                        <a href="<?php echo $F5_40;?>" class="sapn"><?php echo $F5; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Gestion de Projet & Projets de création d’entreprise</a>
                        <a href="<?php echo $F5_41;?>" class="sapn"><?php echo $F5; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Projet de fin de cycle</a>
                        <a href="<?php echo $F5_42;?>" class="sapn"><?php echo $F5; ?></a>
                    </td</tr>
                </table>
