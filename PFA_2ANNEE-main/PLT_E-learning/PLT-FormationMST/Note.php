<?php
    ...
    // BASE DE DONNEES
        ...
        $info=$database->prepare("SELECT * FROM NoteEtu WHERE ID_Etu='{$unique_id}' AND  ID_Formation='4'");
        if($info->execute()){
        ...
        <div class="contant">
            <h3>Les cours que je suis : </h3>
                <table>
                    ...
                    <tr>
                        <td><a href="#">Management des Projets</a></td>
                    ...
                    <tr>
                        <td><a href="#">Marketing International</a></td>
                    ...
                    <tr>
                        <td><a href="#">Audit des Procédures et Tableaux de Bord </a></td>
                    ...
                    <tr>
                        <td><a href="#">Finance Internationale</a></td>
                    ...
                    <tr>
                        <td><a href="#">Analyse de Données des Systèmes d’Information</a></td>
                ...
                <table>
                    ...
                    <tr><th>Nom du cours</th><th>Note</th></tr>
                    <tr>
                        <td><a href="#">Transformation Digitale</a></td>
                    ...
                    <tr>
                        <td><a href="#">Audit du système d’information</a></td>
                    ...
                    <tr>
                        <td><a href="#">Commerce Electronique</a></td>
                    ...
                    <tr>
                        <td><a href="#">Audit Social et contrôle de Gestion Social</a></td>
                    ...
                    <tr>
                        <td><a href="#">Finance de marché : Gestion de Portefeuille </a></td>
                    ...
                    <tr>
                        <td><a href="#">Techniques Bancaires Avancées </a></td>
                ...
                <table>
                    ...
                    <tr><th>Nom du cours</th><th>Note</th></tr>
                    <tr>
                        <td><a href="#">CRM : Management de la Relation Client</a></td>
                    ...
                    <tr>
                        <td><a href="#">Management des équipes et Gestion des conflits</a></td>
                    ...
                    <tr>
                        <td><a href="#">Marketing direct et Marketing des services</a></td>
                    ...
                    <tr>
                        <td><a href="#">Finance Avancée<</a></td>
                    ...
                    <tr>
                        <td><a href="#">Contrôle de Gestion Approfondi</a></td>
                    ...
                    <tr>
                        <td><a href="#">Développement Personnel</a></td>
