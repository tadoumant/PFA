...
<body>
    ...
    <section class="home">  
        <div id="slider">
            <div >
                <h1>MANAGEMENT DES SYSTÈMES ET TECHNOLOGIES DE L’INFORMATION ET DE COMMUNICATION (BAC+5)</h1>
                            ...
                            <div class="slide-content">
                              <a href="cours/cours1.php" class="mini-box " >
                                ...
                                <div class="info-box">
                                    ...
                                    <h3>SEMESTRE 7 : ( MP , MI , APTB , FI )</h3>
                                </div>
                              </a>
                              <a href="cours/cours2.php" class="mini-box " >
                                ...
                                <div class="info-box">
                                    <div class="circl"> <small>0%</small></div>
                                    <h3>SEMESTRE 8 : ( TD , CE , NMA , ASCGS )</h3>
                                </div>
                              </a>
                              <a href="cours/cours3.php" class="mini-box " >
                                ...
                                <div class="info-box">
                                    <div class="circl"> <small>0%</small></div>
                                    <h3>SEMESTRE 9 : ( CRM , DP , CGA , MDMS )</h3>
                                </div>
                              </a>
