<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F4-1'){
                $F4_1=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F4-2'){
                $F4_2=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F4-3'){
                $F4_3=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F4-4'){
                $F4_4=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F4-5'){
                $F4_5=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F4-6'){
                $F4_6=$AffichierCour['Position'];
            }
        }
    $F4='- Cours -';
    }else{
        ...
        <div class="contant">
            <table>
                    <tr><td>
                        ...
                        <a href="<?php echo $F4_1;?>" class="sapn"><?php echo $F4;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Marketing International</a>
                        <a href="<?php echo $F4_2;?>" class="sapn"><?php echo $F4;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Audit des Procédures et Tableaux de Bord</a>
                        <a href="<?php echo $F4_3;?>" class="sapn"><?php echo $F4;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Finance Internationale</a>
                        <a href="<?php echo $F4_4;?>" class="sapn"><?php echo $F4;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Analyse de Données des Systèmes d’Information</a>
                        <a href="<?php echo $F4_5;?>" class="sapn"><?php echo $F4;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Techniques de Communication: Français – Anglais</a>
                        <a href="<?php echo $F4_6;?>" class="sapn"><?php echo $F4;?></a>
                    </td</tr>
                </table>
        </div>
    </section>
