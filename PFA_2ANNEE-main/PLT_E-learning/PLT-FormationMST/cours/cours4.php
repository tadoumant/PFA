<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F4-23'){
                $F4_23=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F4-24'){
                $F4_24=$AffichierCour['Position'];
            }
        }
    $F4='- Cours -';
    }else{
        ...
        <div class="contant">
            <table>
                    <tr><td>
                        ...
                        <a href="<?php echo $F4_23;?>" class="sapn"><?php echo $F4;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Séminaires</a>
                        <a href="<?php echo $F4_24;?>" class="sapn"><?php echo $F4;?></a>
                    </td</tr>
                </table>
        </div>
    </section>
