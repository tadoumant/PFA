<?php
    ...
    // BASE DE DONNEES
        ...
        $info=$database->prepare("SELECT * FROM NoteEtu WHERE ID_Etu='{$unique_id}' AND  ID_Formation='2'");
        if($info->execute()){
        ...
        <div class="contant">
            <h3>Les cours que je suis : </h3>
                ...
                <table>
                    ...
                    <tr>
                        <td><a href="#">Normes et méthodologie de l’Audit</a></td>
                    ...
                    <tr>
                        <td><a href="#">Audit Comptable et Financier</a></td>
                    ...
                    <tr>
                        <td><a href="#">Finance de Marché et Gestion de Portefeuille</a></td>
                ...
                <table>
                    ...
                    <tr><th>Nom du cours</th><th>Note</th></tr>
                    <tr>
                        <td><a href="#">Audit et contrôle Juridique et Fiscal</a></td>
                    ...
                    <tr>
                        <td><a href="#">Contrôle Interne et gestion des risques</a></td>
                    ...
                    <tr>
                        <td><a href="#">Contrôle de Gestion et gestion budgétaire</a></td>
                    ...
                    <tr>
                        <td><a href="#">Audit spécifique et Audit Stratégique</a></td>
                    ...
                    <tr>
                        <td><a href="#">Datamining : SI Décisionnel</a></td>
