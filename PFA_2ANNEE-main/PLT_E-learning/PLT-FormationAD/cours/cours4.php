<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F2-24'){
                $F2_24=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F2-25'){
                $F2_25=$AffichierCour['Position'];
            }
        }
    $f2=' - Cours - ';
    }else{
        ...
        <div class="contant">
            <table>
                    <tr><td>
                        ...
                        <a href="<?php echo $F2_24;?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Séminaires</a>
                        <a href="<?php echo $F2_25;?>" class="sapn"><?php echo $f2; ?></a>
                    </td</tr>
                </table>
