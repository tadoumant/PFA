<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F6-7'){
                $F6_7=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-8'){
                $F6_8=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-9'){
                $F6_9=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-10'){
                $F6_10=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-11'){
                $F6_11=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-12'){
                $F6_12=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-13'){
                $F6_13=$AffichierCour['Position'];
            }
        }
    $F6='- Cours -';
    }else{
        ...
        <div class="contant">
            <table>
                    <tr><td>
                        ...
                        <a href="<?php echo $F6_7;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Simulation industrielle et logistique</a>
                        <a href="<?php echo $F6_8;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Management industriel :(GPAO) / (GMAO)</a>
                        <a href="<?php echo $F6_9;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Gestion des Achats et de l’Approvisionnement et Sureté de Fonctionnement</a>
                        <a href="<?php echo $F6_10;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Supervisons industrielle et MES</a>
                        <a href="<?php echo $F6_11;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Techniques de communication :( Français – Anglais )</a>
                        <a href="<?php echo $F6_12;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Projet de Fin d’Année</a>
                        <a href="<?php echo $F6_13;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
