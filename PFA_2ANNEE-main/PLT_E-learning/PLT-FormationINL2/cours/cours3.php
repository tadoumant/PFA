<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F6-14'){
                $F6_7=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-15'){
                $F6_8=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-16'){
                $F6_9=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-17'){
                $F6_10=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-18'){
                $F6_11=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F6-19'){
        ...
        <div class="contant">
            <table>
                    <tr><td>
                        ...
                        <a href="<?php echo $F6_14;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Lean Management et Six Sigma</a>
                        <a href="<?php echo $F6_15;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Qualité et Management des Risques</a>
                        <a href="<?php echo $F6_16;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Management Visuel et Tableau de Bord</a>
                        <a href="<?php echo $F6_17;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">E_Logistique et Industrie 4.0</a>
                        <a href="<?php echo $F6_18;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Projets Industriels et Logistiques</a>
                        <a href="<?php echo $F6_19;?>" class="sapn"><?php echo $F6;?></a>
                    </td</tr>
                </table>
