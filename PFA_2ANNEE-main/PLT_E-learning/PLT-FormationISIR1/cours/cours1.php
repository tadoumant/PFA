<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F9-1'){
                $F9_1=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F9-2'){
                $F9_2=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F9-3'){
                $F9_3=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F9-4'){
                $F9_4=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F9-5'){
                $F9_5=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F9-6'){
                $F9_6=$AffichierCour['Position'];
            }
        }
    $F8='- Cours -';
    }else{
        ...
        <div class="contant">
            <table>
                    <tr><td>
                        ...
                        <a href="<?php echo $F9_1;?>" class="sapn"><?php echo $F9;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Développement Distribué et 2EE</a>
                        <a href="<?php echo $F9_2;?>" class="sapn"><?php echo $F9;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Interconnexion des réseaux (CCNA 3/4)</a>
                        <a href="<?php echo $F9_3;?>" class="sapn"><?php echo $F9;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">BD Aspect Avancés et Certification Oracle</a>
                        <a href="<?php echo $F9_4;?>" class="sapn"><?php echo $F9;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Administration et Sécurité pour SI</a>
                        <a href="<?php echo $F9_5;?>" class="sapn"><?php echo $F9;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Techniques de Communication: Français – Anglais</a>
                        <a href="<?php echo $F9_6;?>" class="sapn"><?php echo $F9;?></a>
                    </td</tr>
                </table>
        </div>
    </section>
