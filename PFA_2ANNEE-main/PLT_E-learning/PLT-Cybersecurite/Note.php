...
$info=$database->prepare("SELECT * FROM NoteEtu WHERE ID_Etu='{$unique_id}' AND ID_Formation='14' ");
if($info->execute()){
    ...
    <section class="home home4"> 
        <div class="contant">
            <h3>Les cours que je suis : </h3>
                <table>
                    <th colspan="2" class="title">3e Année</th>
                    <tr><th>Nom du cours</th><th>Note</th></tr>
                    <tr>
                        <td><a href="#">SCIENCES DE L'INGÉNIEUR </a></td>
                    ...
                    <tr>
                        <td><a href="#">MANAGEMENT DE PROJETS</a></td>
                    ...
                    <tr>
                        <td><a href="#">ACTIVITÉS ANNUELLES</a></td>
                    ...
                    <tr>
                        <td><a href="#">OUTILS DE COMMUNICATION</a></td>
