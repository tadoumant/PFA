<?php
    ...
    // BASE DE DONNEES
        ...
        $info=$database->prepare("SELECT * FROM NoteEtu WHERE ID_Etu='{$unique_id}' AND  ID_Formation='10'");
        if($info->execute()){
        ...
        <div class="contant">
            <h3>Les cours que je suis : </h3>
                <table>
                    ...
                    <tr>
                        <td><a href="#">Systèmes Télécoms I</a></td>
                    ...
                    <tr>
                        <td><a href="#">Développement Distribué et 2EE</a></td>
                    ...
                    <tr>
                        <td><a href="#">BD Aspect Avancés et Certification Oracle</a></td>
                ...
                <table>
                    ...
                    <tr><th>Nom du cours</th><th>Note</th></tr>
                    <tr>
                        <td><a href="#">Communication Numérique</a></td>
                    ...
                    <tr>
                        <td><a href="#">Communication Télécoms</a></td>
                    ...
                    <tr>
                        <td><a href="#">Traitement de l’Information et Codage Avancé</a></td>
                ...
                <table>
                    ...
                    <tr><th>Nom du cours</th><th>Note</th></tr>
                    <tr>
                        <td><a href="#">Systèmes Télécoms II</a></td>
                    ...
                    <tr>
                        <td><a href="#">Dimensionnement des réseaux</a></td>
                    ...
                    <tr>
                        <td><a href="#">Réseaux Intelligents</a></td>
                    ...
                    <tr>
                        <td><a href="#">Communications par Satellite</a></td>
                    ...
                    <tr>
                        <td><a href="#">Communication Optiques</a></td>
