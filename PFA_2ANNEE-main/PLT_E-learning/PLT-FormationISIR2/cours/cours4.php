<?php
    ...
    if($AffichierCour->execute()){
        foreach($AffichierCour as $AffichierCour){
            if($AffichierCour['ID_Mat'] == 'F10-26'){
                $F10_26=$AffichierCour['Position'];
            }elseif($AffichierCour['ID_Mat'] == 'F10-27'){
                $F10_27=$AffichierCour['Position'];
            }
        }
    $F10='- Cours -';
    }else{
        ...
        <div class="contant">
            <table>
                    <tr><td>
                        ...
                        <a href="<?php echo $F10_26;?>" class="sapn"><?php echo $F10;?></a>
                    </td</tr>
                    <tr><td>
                        <a href="#">Séminaires</a>
                        <a href="<?php echo $F10_27;?>" class="sapn"><?php echo $F10;?></a>
                    </td</tr>
            </table>
        </div>
    </section>
