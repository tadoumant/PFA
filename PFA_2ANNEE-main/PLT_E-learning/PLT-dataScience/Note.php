<?php
    ...
    $info=$database->prepare("SELECT * FROM NoteEtu WHERE ID_Etu='{$unique_id}' AND ID_Formation='12'");
    if($info->execute()){
        ...
        <div class="contant">
            <h3>Les cours que je suis : </h3>
                <table>
                    ...
                    <tr>
                        <td><a href="#"> Les outils du scientifique des données</a></td>
                    ...
                    <tr>
                        <td><a href="#">La programmation en R</a></td>
                    ...
                    <tr>
                        <td><a href="#">Obtenir et trier des données</a></td>
                    ...
                    <tr>
                        <td><a href="#">Exploration analytique de données</a></td>
                    ...
                    <tr>
                        <td><a href="#"> Recherche reproductible</a></td>
                    ...
                    <tr>
                        <td><a href="#">Inférence statistique</a></td>
                    ...
                    <tr>
                        <td><a href="#">Modèles de régression</a></td>
                    ...
                    <tr>
                        <td><a href="#">Apprentissage mécanique pratique</a></td>
                    ...
                    <tr>
                        <td><a href="#">Développement de produits de données</a></td>
                    ...
                    <tr>
                        <td><a href="#">Pojet final de science des données</a></td>
