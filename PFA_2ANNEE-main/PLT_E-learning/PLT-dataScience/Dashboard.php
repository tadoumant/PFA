                            ...
                            <div class="slide-content">
                              <a href="cours/cours1.php" class="mini-box " >
                                ...
                                <div class="info-box">
                                    ...
                                    <h3>Les outils du scientifique des données</h3>
                                </div>
                              </a>
                              ...
                              <a href="cours/cours3.php" class="mini-box " >
                                ...
                                <div class="info-box">
                                    <div class="circl"> <small>0%</small></div>
                                    <h3>Obtenir et trier des données</h3>
                                </div>
                              </a>
                              <a href="cours/cours4.php" class="mini-box " >
                                <div class="img"><img src="image/4.jpeg" alt=""></div>
                                <div class="info-box">
                                    <div class="circl"> <small>0%</small></div>
                                    <h3>Exploration analytique de données</h3>
                                </div>
                              </a>
                         ...
                         <div class="slide slide_2">
                            <div class="slide-content">
                              ...
                              <a href="cours/cours8.php" class="mini-box " >
                                <div class="img"><img src="image/8.jpeg" alt=""></div>
                                <div class="info-box">
                                    <div class="circl"> <small>0%</small></div>
                                    <h3>Apprentissage mécanique pratique</h3>
                                </div>
                              </a>
                              <a href="cours/cours9.php" class="mini-box " >
                                ...
                                <div class="info-box">
                                    <div class="circl"> <small>0%</small></div>
                                    <h3>Développement de produits de données</h3>
                                </div>
                              </a>
                              <a href="cours/cours10.php" class="mini-box " >
                                <div class="img"><img src="image/10.jpg" alt=""></div>
                                <div class="info-box">
                                    <div class="circl"> <small>0%</small></div>
                                    <h3>Pojet final de science des données</h3>
                                </div>
                              </a>
                            </div>
                         </div>
