<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F3-11','3','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Publicité et Concurrence :( Publicité– Dynamique économique ) </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Publicité et Concurrence :( Publicité– Dynamique économique )</h1>
