<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F3-10','3','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Marketing de Vente, d’Achat et de Négociation  </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Marketing de Vente, d’Achat et de Négociation </h1>
