<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F12-7','12','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Décrire les nouvelles utilisations des modèles de régression tels que le lissage des nuages de points</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Décrire les nouvelles utilisations des modèles de régression tels que le lissage des nuages de points</h1>
