<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F12-9','12','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Développer des applications de base et des graphiques interactifs en utilisant GoogleVis</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Développer des applications de base et des graphiques interactifs en utilisant GoogleVis</h1>
