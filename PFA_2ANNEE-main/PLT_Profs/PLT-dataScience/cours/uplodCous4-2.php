...
<head>
    ...
    <title>Réaliser des représentations graphiques de données à très haute dimension</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Réaliser des représentations graphiques de données à très haute dimension</h1>
