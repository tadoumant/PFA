...
<head>
    ...
    <title>Construire une présentation R Markdown qui inclut une visualisation des données</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Construire une présentation R Markdown qui inclut une visualisation des données</h1>
