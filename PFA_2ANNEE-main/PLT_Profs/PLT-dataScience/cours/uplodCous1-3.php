<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F12-1','12','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Comprendre les données, les problèmes et les outils utilisés par les analystes de données</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Comprendre les données, les problèmes et les outils utilisés par les analystes de données</h1>
