...
<head>
    ...
    <title>Organiser l'analyse des données pour les rendre plus reproductibles</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Organiser l'analyse des données pour les rendre plus reproductibles</h1>
