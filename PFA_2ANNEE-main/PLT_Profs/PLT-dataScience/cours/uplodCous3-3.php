<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F12-3','12','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Appliquer les principes de base du nettoyage des données pour rendre les données / propres</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Appliquer les principes de base du nettoyage des données pour rendre les données / propres</h1>
