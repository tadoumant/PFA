...
<head>
    ...
    <title>Créer un dossier de présentation pour mettre en valeur ses résultats</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Créer un dossier de présentation pour mettre en valeur ses résultats</h1>
