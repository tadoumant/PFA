<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F12-6','12','$id','$fileName','$fileType','$position')");
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>omprendre le processus consistant à tirer des conclusions sur les populations ou des vérités scientifiques à partir de données</h1>
