...
<head>
    ...
    <title>Rédiger une analyse de données reproductibles en utilisant le tricot</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Rédiger une analyse de données reproductibles en utilisant le tricot</h1>
