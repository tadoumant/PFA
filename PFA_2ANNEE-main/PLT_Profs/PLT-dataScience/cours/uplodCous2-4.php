<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F12-2','12','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Recueillir des informations détaillées à l'aide du profiler R</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Recueillir des informations détaillées à l'aide du profiler R</h1>
