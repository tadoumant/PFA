<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F12-4','12','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Appliquer les techniques d'analyse de clusters pour localiser des modèles dans les données</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Appliquer les techniques d'analyse de clusters pour localiser des modèles dans les données</h1>
