...
<head>
    ...
    <title>Créer un produit de données qui raconte une histoire à un public de masse</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Créer un produit de données qui raconte une histoire à un public de masse</h1>
