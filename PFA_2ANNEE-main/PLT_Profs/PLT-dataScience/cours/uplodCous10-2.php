<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F12-10','12','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Appliquez vos compétences en matière d'analyse exploratoire des données</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Appliquez vos compétences en matière d'analyse exploratoire des données</h1>
