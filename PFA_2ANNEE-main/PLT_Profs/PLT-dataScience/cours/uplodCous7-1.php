...
<head>
    ...
    <title>Utiliser l'analyse de régression, les moindres carrés et l'inférence</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Utiliser l'analyse de régression, les moindres carrés et l'inférence</h1>
