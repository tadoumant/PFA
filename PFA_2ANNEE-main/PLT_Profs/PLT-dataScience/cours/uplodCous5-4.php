<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F12-5','12','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Publier des documents Web reproductibles en utilisant la fonction de démarque (Markdown)</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Publier des documents Web reproductibles en utilisant la fonction de démarque (Markdown)</h1>
