...
<head>
    ...
    <title>Obtenir des données utilisables sur le web, les API et les bases de données</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Obtenir des données utilisables sur le web, les API et les bases de données</h1>
