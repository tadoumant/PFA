...
<head>
    ...
    <title>Comprendre des concepts tels que les ensembles de formation et de tests, le suréquipement et les taux d'erreur</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Comprendre des concepts tels que les ensembles de formation et de tests, le suréquipement et les taux d'erreur</h1>
