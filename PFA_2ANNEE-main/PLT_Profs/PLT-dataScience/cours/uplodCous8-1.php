...
<head>
    ...
    <title>Utiliser les éléments de base de la construction et de l'application des fonctions de prédiction</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Utiliser les éléments de base de la construction et de l'application des fonctions de prédiction</h1>
