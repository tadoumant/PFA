<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F4-5','4','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Analyse de Données des Systèmes d’Information  </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Analyse de Données des Systèmes d’Information </h1>
