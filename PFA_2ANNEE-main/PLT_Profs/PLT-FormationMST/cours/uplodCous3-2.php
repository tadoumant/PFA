<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F4-16','4','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Management des équipes et Gestion des conflits  </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Management des équipes et Gestion des conflits </h1>
