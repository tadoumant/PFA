<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F10-14','10','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Techniques de Communication: Français – Anglais </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Techniques de Communication: Français – Anglais</h1>
