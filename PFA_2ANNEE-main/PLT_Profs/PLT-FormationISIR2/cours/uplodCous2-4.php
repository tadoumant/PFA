<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F10-10','10','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Traitement de l’Information et Codage Avancé </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Traitement de l’Information et Codage Avancé</h1>
