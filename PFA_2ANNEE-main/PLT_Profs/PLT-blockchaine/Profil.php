        ...
        <div class="Info-g">
                        ...
                        <div class="box-formation">
                            ...
                            <div class="m">
                                ...
                                <form action="" class="form2">
                                    ...
                                    <h1>✎</h1><button type="submit" value="" name="mod2" class="inputMod">✎</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="mini-box2">
                        <div class="m">
                            ...
                            <form action="" class="form3">
                                ...
                                <h1>✎</h1><button type="submit" value="" name="mod3" class="inputMod">✎</button>
                            </form>
                        </div>
                        <div class="m">
                            ...
                            <form action="" class="form4">
                                ...
                                <h1>✎</h1><button type="submit" value="" name="mod4" class="inputMod">✎</button>
                            </form>
                        </div>
            ...
            <div class="connexion">
                ...
                <div class="box-connexion">
                    <h3>Premier accès au site</h3><p> <?php echo $PremierAccesAuSite;?></p>
                    <h3>Dernier accès au site</h3><p><?php echo $date;?></p>
                </div>
            </div>
        </div>
        <div class="cours">
            ...
            <div class="box-cours">
                ...
                <a href="#"> - Comprendre et pouvoir expliquer la technologie Blockchain et ses différentes briques</a> 
                <a href="#"> - Appréhender la Blockchain Ethereum et son fonctionnement</a>
                <a href="#"> - Exploiter les outils de développement sur Ethereum</a>   
                <a href="#"> - Développer avec les fondements du langage solidity</a>   
                <a href="#"> - Utiliser les bonnes pratiques de solidity pour son smart contract</a>   
                <a href="#"> - Découvrir les frameworks, les bibliothèques et les services les plus utilisés sur Ethereum</a>   
                <a href="#"> - Faire le lien avec le front-end </a>   
                <a href="#"> - Utiliser l’approche CI/CD pour son développement et son intégration</a>   
                <a href="#"> - Maîtriser la finance décentralisée</a>
                <a href="#"> - S’insérer professionnellement dans l’écosystème</a>
            </div>
        </div>
    </section>
