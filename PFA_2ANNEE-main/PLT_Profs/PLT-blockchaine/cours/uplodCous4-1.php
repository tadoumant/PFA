<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F11-4','11','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Optimiser son smart contract en matière de consommation de gas</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Optimiser son smart contract en matière de consommation de gas</h1>
