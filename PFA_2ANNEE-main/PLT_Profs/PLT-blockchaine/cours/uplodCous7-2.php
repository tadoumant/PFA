<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F11-7','11','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Implémenter des tests fonctionnels, assurer le fonctionnement du smart contract avant déploiement</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Implémenter des tests fonctionnels, assurer le fonctionnement du smart contract avant déploiement</h1>
