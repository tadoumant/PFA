<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F11-2','11','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Créer et interagir avec sa propre Blockchain privée</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Créer et interagir avec sa propre Blockchain privée</h1>
