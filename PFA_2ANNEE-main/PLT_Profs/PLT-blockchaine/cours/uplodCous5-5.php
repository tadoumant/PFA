<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F11-5','11','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Déployer son smart contract sur Ethereum à l’aide du processus de migration de Truffle</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Déployer son smart contract sur Ethereum à l’aide du processus de migration de Truffle</h1>
