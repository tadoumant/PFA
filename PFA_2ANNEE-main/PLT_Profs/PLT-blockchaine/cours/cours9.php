...
<body>
    ...
    <section class="home home5"> 
        <div class="contant">
            <table>
                    <tr><td>
                        <a href="uplodCous9-1.php">Présenter ses compétences à l’oral et à l’écrit</a>
                        <a href="" class="sapn">Non disponible</a>
                    </td</tr>
                    <tr><td>
                        <a href="uplodCous9-2.php">Respecter le bon formalisme pour le CV</a>
                        <a href="" class="sapn">Non disponible</a>
                    </td</tr>
                    <tr><td>
                        <a href="uplodCous9-3.php">Négocier sa rémunération</a>
                        <a href="" class="sapn">Non disponible</a>
                    </td</tr>
                    <tr><td>
                        <a href="uplodCous9-4.php">Techniques de Communication V :  Français – Anglais</a>
                        <a href="" class="sapn">Non disponible</a>
                    </td</tr>
                </table>
