<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        // move_uploaded_file($filePosition,$fileName);
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F11-1','11','$id','$fileName','$fileType','$position')");
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Comprendre et interagir avec une architecture décentralisée</h1>
