...
<head>
    ...
    <title>Concevoir, configurer et développer sa propre application décentralisée avec Truffle</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Concevoir, configurer et développer sa propre application décentralisée avec Truffle</h1>
