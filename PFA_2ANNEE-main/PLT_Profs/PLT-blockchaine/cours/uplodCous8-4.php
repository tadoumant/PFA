<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F11-8','11','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Interagir avec les protocoles de la DeFi (aave, uniswap, etc.)</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Interagir avec les protocoles de la DeFi (aave, uniswap, etc.)</h1>
