<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F7-28','7','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title> Projet BD-SI : Base de Données et Système d’Information</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Projet BD-SI : Base de Données et Système d’Information</h1>
