<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F8-9','8','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title> Pratique Avancée des Langages PHP 5 et Dot Net</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Pratique Avancée des Langages PHP 5 et Dot Net</h1>
