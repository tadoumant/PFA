<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F8-1','8','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title> Processus de Développement Agiles et Certification Scrum</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Processus de Développement Agiles et Certification Scrum</h1>
