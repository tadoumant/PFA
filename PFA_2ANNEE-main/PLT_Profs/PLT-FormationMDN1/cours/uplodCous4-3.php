<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F1-26','1','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Comptabilité Générale Informatisée : Préparation à la Certification SAGE </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Comptabilité Générale Informatisée : Préparation à la Certification SAGE</h1>
