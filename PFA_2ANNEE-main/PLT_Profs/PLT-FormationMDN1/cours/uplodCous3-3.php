<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F1-18','1','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Management de la Communication dans l’Entreprise </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Management de la Communication dans l’Entreprise</h1>
