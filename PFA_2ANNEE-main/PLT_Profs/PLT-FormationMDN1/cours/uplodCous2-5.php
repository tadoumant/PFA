<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F1-12','1','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Introduction à l’Architecture des Ordinateurs </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Introduction à l’Architecture des Ordinateurs</h1>
