<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F1-1','1','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Structure et Fonctionnement des Entreprises :( Organisation et Fonctionnement d’Entreprises ) </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Structure et Fonctionnement des Entreprises :( Organisation et Fonctionnement d’Entreprises )</h1>
