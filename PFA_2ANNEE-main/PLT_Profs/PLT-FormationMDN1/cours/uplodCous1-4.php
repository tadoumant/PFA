<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F1-4','1','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Initiation à l’Informatique :( Environnement Bureautique– Introduction au Système d’Exploitation ) </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Initiation à l’Informatique :( Environnement Bureautique– Introduction au Système d’Exploitation )</h1>
