<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F1-2','1','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Management des Entreprises :( Introduction au Management– Gestion des Entreprises ) </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Management des Entreprises :( Introduction au Management– Gestion des Entreprises )</h1>
