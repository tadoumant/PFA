    ...
    $ID_Prof=$_SESSION['ID_Prof'];
        $check2=$database->prepare("SELECT * FROM Profs WHERE ID_Prof='$ID_Prof' " );
            ...
            if($check2->rowCount() === 1){
                ...
                if (array_key_exists($_SESSION['formation'], $formationary)) {$for=$formationary[$_SESSION['formation']];}
            }
        ...
        <div class="cours">
            ...
            <div class="box-cours">
                ...
                <div class="cour">
                    ...
                    <a href="#"> - Projet de Fin d’Année</a>
                    <a href="#">SEMESTRE 5:</a>   
                    <a href="#"> - Economie Internationale</a>
                    <a href="#"> - Contrôle de Gestion</a>
                    <a href="#"> - Management Stratégique</a>
                    <a href="#"> - Gestion Financière</a>
                    <a href="#"> - Fiscalité</a>
                    <a href="#"> - Création des Entreprises</a>
                    <a href="#"> - Techniques de Communication V :  Français – Anglais</a>
                    <a href="#"> - E-Recrutement</a>
                    <a href="#">SEMESTRE 6:</a>     
                    <a href="#"> - Ingénierie Financière</a>
                    <a href="#"> - GRH : Gestion des Ressources Humaines</a>
                    <a href="#"> - Droit du travail</a>
                    <a href="#"> - Politique Economique et Monétair</a>
                    <a href="#"> - Techniques Bancaires</a>
                    <a href="#"> - Projet de Fin de Cycle</a>
                </div>
            </div>
        </div>
    </section>
