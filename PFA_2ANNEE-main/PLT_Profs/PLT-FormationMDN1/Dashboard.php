        ...
        <div class="container">
            <div class="box-gen">
                    <a href="cours/cours1.php" class="mini-box " >
                        ...
                        <div class="info-box">
                            <div class="box-circl"><div class="circl"><small>0%</small></div></div> 
                            <h3>SEMESTRE 1 : ( SFE , ME , II )</h3>
                        </div>
                    </a>
                    <a href="cours/cours2.php" class="mini-box " >
                        ...
                        <div class="info-box">
                            <div class="box-circl"><div class="circl"><small>0%</small></div></div> 
                            <h3>SEMESTRE 2 : ( MFP , MB , CG2 , ID)</h3>
                        </div>
                    </a>
                    ...
                    <div class="img"><img src="image/3.jpg" alt=""></div>
                        <div class="info-box">
                            <div class="box-circl"><div class="circl"><small>0%</small></div></div> 
                            <h3>SEMESTRE 3 : ( AAM , WM , MCE , GC , IF)</h3>
                        </div>
                    </a>
                    <a href="cours/cours4.php" class="mini-box " >
                        ...
                        <div class="info-box">
                            <div class="box-circl"><div class="circl"><small>0%</small></div></div> 
                            <h3>SEMESTRE 4 : ( BPEP , CA , CGI , GO , SGBD , DA)</h3>
                        </div>
                    </a>
                    ...
                    <a href="cours/cours6.php" class="mini-box " >
                        ...
                        <div class="info-box">
                            <div class="box-circl"><div class="circl"><small>0%</small></div></div> 
                            <h3>SEMESTRE 6 : ( IF , GRH , DEM , PFC)</h3>
                        </div>
                    </a>
                </div>
            </div>
