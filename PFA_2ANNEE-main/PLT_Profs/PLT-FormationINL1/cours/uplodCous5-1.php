<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F5-30','5','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title> Achat, approvisionnement et chaîne logistique</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Achat, approvisionnement et chaîne logistique</h1>
