<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F5-36','5','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Gestion de la Production et de la maintenance </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Gestion de la Production et de la maintenance</h1>
