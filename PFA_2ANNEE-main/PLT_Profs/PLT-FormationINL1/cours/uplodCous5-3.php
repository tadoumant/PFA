<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F5-32','5','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Logistique, Transport, Gestion des Entrepôts et Distribution </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Logistique, Transport, Gestion des Entrepôts et Distribution</h1>
