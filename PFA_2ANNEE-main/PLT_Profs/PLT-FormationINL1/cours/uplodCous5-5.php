<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F5-34','5','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Systèmes d’information appliqués à la gestion des flux </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Systèmes d’information appliqués à la gestion des flux</h1>
