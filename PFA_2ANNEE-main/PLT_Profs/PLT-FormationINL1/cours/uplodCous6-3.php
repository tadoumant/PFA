<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F5-38','5','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title> Gestion de Projet & Projets de création d’entreprise</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Gestion de Projet & Projets de création d’entreprise </h1>
