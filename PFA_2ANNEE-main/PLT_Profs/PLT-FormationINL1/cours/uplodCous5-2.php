<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F5-31','5','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title> Procédés de fabrication et risques industriels</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Procédés de fabrication et risques industriels</h1>
