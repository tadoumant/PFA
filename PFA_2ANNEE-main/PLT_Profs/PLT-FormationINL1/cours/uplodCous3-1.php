<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F5-17','5','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Informatique Industrielle : Modélisation des processus Industriels /Bases de Données I </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Informatique Industrielle : Modélisation des processus Industriels /Bases de Données I</h1>
