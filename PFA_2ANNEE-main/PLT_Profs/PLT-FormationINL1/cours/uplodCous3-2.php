<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F5-18','5','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title> Théorie des graphes et Programmation Linéaire</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Théorie des graphes et Programmation Linéaire</h1>
