        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="Note_Etu.php"><i class="fa fa-file-archive-o icon" aria-hidden="true"></i><span class="text nav-text"> Note </span></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="box-gen">
                    <a href="cours/cours1.php" class="mini-box " >
                        ...
                        <div class="info-box">
                            ...
                            <h3>SEMESTRE 1 : ( MGI , ME , II , Algo , LC , E)</h3>
                        </div>
                    </a>
                    <a href="cours/cours2.php" class="mini-box " >
                        ...
                        <div class="info-box">
                            ...
                            <h3>SEMESTRE 2 : (AO1 , Algo adv , LC adv , CLogiue)</h3>
                        </div>
                    </a>
                    ...
                    <a href="cours/cours4.php" class="mini-box " >
                        ...
                        <div class="info-box">
                            ...
                            <h3>SEMESTRE 4 : (AACL , PFRI , AD , SIAGF)</h3>
                        </div>
                    </a>
                    <a href="cours/cours5.php" class="mini-box " >
                        ...
                        <div class="info-box">
                            ...
                            <h3>SEMESTRE 5 : (AACL , PFRI , GPCE , SIAGF)</h3>
                        </div>
                    </a>
                    <a href="cours/cours6.php" class="mini-box " >
                        ...
                        <div class="info-box">
                            ...
                            <h3>SEMESTRE 6 : (GPM , MQ , GPCE , PFC)</h3>
                        </div>
                    </a>
                </div>
            </div>
