<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F14-6','14','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Planification de projets SI : cadrage, lots, MS Project</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Planification de projets SI : cadrage, lots, MS Project</h1>
