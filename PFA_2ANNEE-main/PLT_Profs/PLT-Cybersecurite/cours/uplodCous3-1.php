<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F14-3','14','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Linux administration avancée (LPIC 101/ Red Hat I)</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Linux administration avancée (LPIC 101/ Red Hat I)</h1>
