<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F14-7','14','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>E-learning (FOAD) : langues, culture entreprise, informatique</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>E-learning (FOAD) : langues, culture entreprise, informatique</h1>
