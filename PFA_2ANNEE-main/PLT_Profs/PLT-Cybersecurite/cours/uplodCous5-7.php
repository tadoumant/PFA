<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F14-5','14','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Préparation et passage de la certification CEH (Certified Ethical Hacker)</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Préparation et passage de la certification CEH (Certified Ethical Hacker)</h1>
