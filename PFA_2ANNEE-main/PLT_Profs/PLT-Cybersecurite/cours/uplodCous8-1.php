<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F14-8','14','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Anglais : vocabulaire business, préparation au TOEIC</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Anglais : vocabulaire business, préparation au TOEIC</h1>
