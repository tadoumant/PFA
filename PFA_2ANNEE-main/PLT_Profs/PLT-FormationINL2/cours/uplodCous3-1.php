<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F6-14','6','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Supply Chain Management et Techniques du commerce et des affaires internationales</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Supply Chain Management et Techniques du commerce et des affaires internationales</h1>
