<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F6-10','6','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Gestion des Achats et de l’Approvisionnement et Sureté de Fonctionnement </title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Gestion des Achats et de l’Approvisionnement et Sureté de Fonctionnement </h1>
