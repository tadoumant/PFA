<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F6-3','6','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title> Conception et fabrication assistées par ordinateurs (CFAO)</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1> Conception et fabrication assistées par ordinateurs (CFAO)</h1>
