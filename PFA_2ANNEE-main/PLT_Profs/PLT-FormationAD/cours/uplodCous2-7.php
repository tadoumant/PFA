<?php
    ...
    if(isset($_REQUEST['upload'])){
        ...
        $uploadFile=$database->prepare("INSERT INTO Cours(ID_Mat,ID_Formation,ID_Cours,nameFile,TypeFile,Position) 
                VALUES('F2-13','2','$id','$fileName','$fileType','$position')");
...
<head>
    ...
    <title>Finance de Marché et Gestion de Portefeuille</title>
...
<body>
    ...
    <section class="home home6"> 
        <div class="contant"> 
            <h1>Finance de Marché et Gestion de Portefeuille</h1>
